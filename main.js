...
btnLeyenda2.addEventListener('click', () => {
  ...
  const contenidoGuajojo = `
    <div class="contenedor-3d">
      <!-- Activamos alpha: true para permitir fondos transparentes (la cámara) -->
      <a-scene embedded style="width: 100%; height: 100%;" renderer="alpha: true; antialias: false; precision: mediump;">
        
        <a-assets>
          <a-asset-item id="modelo-guajojo" src="/guajojo.glb"></a-asset-item>
        </a-assets>

        <!-- EL TRUCO MAGNÍFICO: hide-on-enter-ar oculta el cielo cuando se abre la cámara -->
        ...
        <!-- Acercamos al Guajojó a 3 metros de distancia para que aparezca dentro de la habitación -->
        <a-gltf-model src="#modelo-guajojo" position="0 0 -3" scale="0.2 0.2 0.2"></a-gltf-model>
